    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawer = new DrawerBuilder()
                ...
                .addDrawerItems(
                        ...
                        new SecondaryDrawerItem().withName("Google+").withIcon(R.drawable.ic_google).withIdentifier(23).withSelectable(false),
    ...
    public void onBackPressed() {
        if (drawer != null && drawer.isDrawerOpen()) {
            ...
            if (backPressed + 2500 > System.currentTimeMillis()) {
                ...
                Toast.makeText(this.getApplicationContext(), "Нажмите еще раз", Toast.LENGTH_SHORT).show();
            }
